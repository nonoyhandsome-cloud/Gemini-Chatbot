...
2. Install Visual Studio Code: Go to: https://code.visualstudio.com

3. Extract the Project Files: Locate the downloaded file, right-click the file then select extract all after that choose a location where the project folder will be stored.
